...
container.register({
    ...
    profileRepository: awilix.asFunction(require('./data-access-layer/user-table.js')),
    ...
    profileRouter: awilix.asFunction(require('./presentation-layer/routers/profile-router')),
