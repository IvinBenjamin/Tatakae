...
container.register({
    ...
    variusRouter: awilix.asFunction(('./presentation-layer/routers/varius-router')),
    userRouter: awilix.asFunction(('./presentation-layer/routers/user-router')),
    feedbackRouter: awilix.asFunction(('./presentation-layer/routers/feedback-router')),
    commentRouter: awilix.asFunction(('./presentation-layer/routers/comment-router')),
